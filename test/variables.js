...
var DappGit = {
  ...
  git: "git@github.com:Ebookcoin/cryptipad.git"
};
...
// Account info for foundation account - EBOOKCOIN > 1,000,000 | Needed for voting, registrations and Tx
var Faccount = {
...
module.exports = {
  ...
  peer : peer,
  ebookcoin : require('./ebookcoin-js'),
  supertest: supertest,
  expect: expect,
  version: version,
  EBOOKCOIN: EBOOKCOIN,
  ...
  randomizeEbookcoin: randomizeEbookcoin,
